...
class ParsingTests(TestBase):
    ...
    def test_error_no_product_parsing(self):
        ...
        assert (
            context.exception.message == "No product selected. Need a "
    ...
    def test_plans_parsing(self):
        ...
        assert plan.created_datetime == arrow.get("2011-01-07T20:46:43+00:00").datetime
        ...
        assert plan.billing_frequency_per == "month"
        assert plan.trial_days == 0
        assert plan.created_datetime == arrow.get("2011-01-07T21:05:42+00:00").datetime
    ...
    def test_plan_with_items_parsing(self):
        ...
        assert item.created_datetime == arrow.get("2011-01-10T22:40:34+00:00").datetime
        item = plan.items[1]
        ...
        assert plan.billing_frequency_per == "month"
        assert plan.trial_days == 0
        assert plan.created_datetime == arrow.get("2011-01-10T22:40:34+00:00").datetime
    ...
    def test_customer_without_items_parsing(self):
        ...
        assert (
            customer.created_datetime == arrow.get("2011-01-10T05:45:51+00:00").datetime
        )
        ...
        assert (
            invoice.created_datetime == arrow.get("2011-01-10T05:45:51+00:00").datetime
        )
        assert invoice.number == 1
        assert (
            invoice.billing_datetime == arrow.get("2011-02-10T05:45:51+00:00").datetime
        )
